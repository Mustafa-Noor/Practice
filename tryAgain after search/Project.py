...
class Ui_MainWindow(object):
        ...
        "")
                ...
                # self.columnSelectionList = QtWidgets.QListWidget(self.centralwidget)
                # self.columnSelectionList.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
                # self.columnSelectionList.addItems(['Title', 'Release Year', 'Duration', 'Director', 'Actor 1', 'Actor 2', 'Genre'])
