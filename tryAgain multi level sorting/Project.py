...
class Ui_MainWindow(object):
        ...
        "color: rgb(170, 0, 127);")
                ...
                self.label_10.setGeometry(QtCore.QRect(550, 140, 91, 41))
        ...
        "")
                ...
                self.pushButton_2.setGeometry(QtCore.QRect(800, 270, 201, 51))
                font = QtGui.QFont()
        ...
        "")
                ...
                self.label_4.setGeometry(QtCore.QRect(50, 200, 91, 41))
                self.label_4.setStyleSheet("font-size:23px;\n"
        "color: rgb(170, 0, 127);")
                self.label_4.setObjectName("label_4")
                self.comboBox = QtWidgets.QComboBox(self.centralwidget)
                self.comboBox.setGeometry(QtCore.QRect(150, 740, 251, 31))
        ...
        "")
                ...
                self.search.setGeometry(QtCore.QRect(680, 140, 251, 31))
        ...
        "background-color: rgb(0, 0, 127);")
                ...
                for i, column in enumerate(columns):
                        ...
                        comboBox.setGeometry(QtCore.QRect(200, 20 + i * 30, 100, 31))  # Set position
...
class MainApp(QtWidgets.QMainWindow):
        def __init__(self):
                ...
                self.columnSelectionList.setGeometry(QtCore.QRect(50, 20, 150, 220))
        ...
        def save_selected_column(self, selected, deselected):
                ...
                # Store the first selected column index
                        ...
                        print("No column selected for filtering.")
